...
"""
    add_motif_entry!(json_x_motifs, html_dict, mode_str, png_rel, label, texts, idx, filter_indices, median_val, group_id, button_text; is_significant=true)
...
function add_motif_entry!(json_x_motifs::Dict, html_dict, mode_str::AbstractString,
    ...
    populate_html_dict!(html_dict, idx, json_x_motifs[mode_str], filter_indices, median_val, group_id, button_text; is_significant=is_significant)
end
