...
@testset "GlyphEctoplasm.jl" begin
    ...
    @testset "mutation_description uses ranges" begin
        ...
        @test md([r], 0.13, "the measured value") ==
              "Mutations at sites 36, 38-41 to nucleotides such as U, CGAC respectively increase the measured value by about 0.13."
        ...
        @test md([r1run], 1.0, "the measured value") ==
              "Mutations at sites 7-14 to nucleotides such as CUCUCGUC increase the measured value by about 1.0."
        # a run of two stays as two tokens on BOTH sides
        r2 = W("ACGU", 10, Bool[1, 1, 0, 0], "GC--")
        @test md([r2], 1.0, "fitness") ==
              "Mutations at sites 10, 11 to nucleotides such as G, C respectively increase fitness by about 1.0."
        ...
        @test md([ra, rb], 0.13, "the measured value") ==
              "Mutations at sites 7-14, 36, 38-41 to nucleotides such as GGUGUUGC, U, CGAC respectively increase the measured value by about 0.13."
        # single site keeps the singular sentence, no range machinery
        r1 = W("ACGU", 10, Bool[0, 1, 0, 0], "-C--")
        @test md([r1], -0.5, "fitness") == "Mutation at site 11 to a nucleotide such as C decreases fitness by about 0.5."
